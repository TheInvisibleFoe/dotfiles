...
\begin{figure}[H]
	...
	\draw (5.5, 6.75) to[american resistor, l={$R_s = 2.2 k\Omega$}, label distance=0.02cm] (7.75, 6.75);
	...
	\draw (10.75, 0.952) to[full ZZener diode] (10.75, 4.452);
