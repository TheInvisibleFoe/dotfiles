...
\end{align}
where \(\psi'(z) = \frac{d^2 \ln \G (z)}{dz^2}\) is called the trigamma function. We have also defined \(t_R = \) We have a relation that relates the real part of the trigamma function 
