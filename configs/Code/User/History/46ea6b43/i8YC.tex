...
\end{figure}
\section{Results}
We have plotted the input and output characteristics with a small experimental anomaly. The current gain of the BJT is found to be $\beta_{2V} = 131.2 \pm 0.31, \beta_{3V} = 195 \pm 2.6, \beta_{4V} = 205 \pm 3.6$.
