...
\begin{itemize}
        \item For the output characteristics, $I_b$ was fluctuating a lot , so the values are correct upto $\pm 3$
\section{Conclusion}
We conclude the experiment by finding the input and output characteristics of the BJT and also the current gain of the BJT. The current gain is found to be quite large, as expected.
\pagebreak
