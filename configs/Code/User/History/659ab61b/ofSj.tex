...
We then fixed the value of $R_c=1k\Omega$ and varied the value of $R_L$ to see the load regulation. The data is given in Table \label{tab:Z} in the Supplementary Section.
