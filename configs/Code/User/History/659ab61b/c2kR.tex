...
The data for this is given in Table \ref{tab:ZDload2.2ohm} in the Supplementary Section.
...
\subsection{Load Regulation}
The data is given in Table \ref{tab:icload} in the Supplementary Section.
