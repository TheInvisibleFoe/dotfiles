...
\end{figure}
\section{Results}
We found out the from the line regulation experiment with the Zener Diode that the breakdown voltage is $V_b = 4.34V$ when
the input voltage is $V_{min} = 10.51V$. 
